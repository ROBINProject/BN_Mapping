...
library("spatstat")
#
setwd("C:/Brasil9sep2014")
red <- readOGR("Puntosred.shp", "Puntosred")
red[1:2, 1:11]
plot(red)
dir.create("C:/Brasil9sep2014/Tablas")
setwd("C:/Brasil9sep2014/Tablas")
...
#
Brasil <- stack(rasterId, rasterlong, rasterlat, rasterFPAR2005, rasterFPAR2013, rasterNDVI2005, rasterNDVI2013, 
                rasterLAI2005, rasterLAI2013, rasterGPP2005, rasterGPP2013, rasterTipologia, rasterPrpanual)
names(Brasil) <- c("ID", "X", "Y", "FPAR2005", "FPAR2013", "NDVI2005", "NDVI2013", "LAI2005", "LAI2013", "GPP2005", "GPP2013", "Tipologia", "Prpanual")
plot(Brasil)
